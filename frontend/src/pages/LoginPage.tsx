...
export function LoginPage({ theme, onLogin, onNavigate }: LoginPageProps) {
        ...
        <div className={`${cardBg} rounded-[48px] p-10 shadow-2xl`}>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <motion.button
              type="submit"
              disabled={loading}
              className={`w-full py-4 rounded-[24px] text-white text-lg transition-all duration-300 flex items-center justify-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 shadow-xl ${
                loading
